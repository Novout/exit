...
const vikingLevelDifficult = computed(() => vikingDifficult(PLAYER.data.island.vikingLevel))
const vikingLevelGain = computed(() => VikingGain(PLAYER.data.island.vikingLevel))
