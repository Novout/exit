<template>
  <div class="absolute z-99 p-4 top-40 left-10 text-md font-poppins flex items-center flex-col w-20 bg-gray text-white rounded-lg">
    ...
    <Button v-else-if="world.cityActive?.owner !== 'main'">Attack</Button>
  </div>
</template>
