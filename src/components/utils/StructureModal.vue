<template>
  <section ref="main" class="p-3 font-poppins absolute rounded-md bg-gray text-white left-65 flex flex-col w-150 max-h-200 overflow-x-hidden overflow-y-auto">
